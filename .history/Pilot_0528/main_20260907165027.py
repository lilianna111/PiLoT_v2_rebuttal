...
class DualProcessTask:        
    def __init__(self, config, init_euler = None, init_trans = None, name = None, sample_num=300, output_folder=None):
        ...
        if output_folder is None:
            output_folder = "/media/amax/PS2000/rebuttal/0906/seed300"
        ...
        self.sample_num_report = os.path.join(output_folder, dataset_name + "_sample_num.txt")
    ...
    def rendering_worker(self):
        ...
        while True:
            ...
            if points_valid.shape[0] < self.sample_num:
                logging.warning(f"裁剪结果有效3D点过少: frame={name}, count={points_valid.shape[0]}")
