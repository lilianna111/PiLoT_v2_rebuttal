...
for target_name in target_names:
    if os.path.exists(f"/media/amax/PS2000/ral/crop/{target_name}.txt"):
        print(f"--------------{target_name}------------------")
        evaluate(f"/media/amax/AE0E2AFD0E2ABE69/datasets/poses/{target_name}.txt", f"/media/amax/PS2000/ral/crop_0628_1/{target_name}.txt")
    else:
