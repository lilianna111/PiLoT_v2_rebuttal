...
import math
# ==== 配置 ====
video_path = '/mnt/sda/MapScape/sup/DJI_20250926152036_0002_V.mp4'  # 输入视频路径
output_dir = '/mnt/sda/MapScape/query/images/DJI_20250926152036_0002_V'       # 输出图像文件夹
frame_interval = 1         # 每隔多少帧保存一次（1 表示逐帧）
target_width = 3840
target_height = 2160
print(output_dir)
# ==== 裁切秒数（可选）====
start_sec = 40              # None 表示从头开始
end_sec = 70               # None 表示直到结束
