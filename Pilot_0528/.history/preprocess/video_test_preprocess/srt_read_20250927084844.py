...
# ==== 配置 ====
srt_file = '/mnt/sda/MapScape/sup/DJI_20250926152036_0002_V.srt'
output_txt = '/mnt/sda/MapScape/query/poses/DJI_20250926152036_0002_V.txt'

# ==== 时间段和帧率 ====
start_sec = 0
fps = 29.97
target_frame_count = 900
