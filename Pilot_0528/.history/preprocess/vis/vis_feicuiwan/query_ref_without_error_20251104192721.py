...
# 配置
ref_dir = "/home/ubuntu/Documents/code/github/FPV/PiLoT/outputs/feicuiwan_sim_seq7"
query_dir = "/mnt/sda/MapScape/query/images/feicuiwan_sim_seq7"
output_path = "/mnt/sda/MapScape/query/estimation/mp4_compare/feicuiwan_sim_seq7"
if not os.path.exists(output_path):
    os.makedirs(output_path)
query_pose_file = "/mnt/sda/MapScape/query/estimation/mp4_compare/USA_seq5_foggy_gif/Render2RAFT/USA_seq5@8@foggy@200.txt"
ref_pose_file = "/mnt/sda/MapScape/query/estimation/mp4_compare/USA_seq5_foggy_gif/Render2RAFT/USA_seq5@8@foggy@200.txt"
start_idx, end_idx = 600, 750
...
def generate_checkerboard_overlay_transparent_v2(ref_crop, query_crop, rows, cols, alpha=0.7):
    ...
    return output
def generate_checkerboard_overlay_transparent(ref_crop, query_crop, rows, cols, alpha=0.7):
    """
    生成带透明度叠加的 checkerboard 图像。
...
y_off = (H - crop_h) // 2
# 棋盘格参数（行列数）
grid_rows, grid_cols = 3, 6  # 共 96 块格子
