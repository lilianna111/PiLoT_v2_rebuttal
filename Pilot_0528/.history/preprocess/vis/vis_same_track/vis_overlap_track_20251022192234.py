...
# ========== 可编辑区域 ==========
FILES = [
    "/media/ubuntu/PS20001/poses/USA_seq2@8@sunny@screen16@200.txt",  # ← 最后一个：RTK-IMU GT
    ...
    "/mnt/sda/MapScape/query/estimation/result_images/Google/GeoPixel/USA_seq2@8@foggy@intensity2@200.txt",  #1589
    "/mnt/sda/MapScape/query/estimation/result_images/Google/GeoPixel/USA_seq2@8@night@intensity2@200.txt",  #1612
