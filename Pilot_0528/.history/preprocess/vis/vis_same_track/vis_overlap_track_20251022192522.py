...
# ========== 可编辑区域 ==========
FILES = [
    "/media/ubuntu/PS20001/poses/switzerland_seq4@8@cloudy@200.txt",  # ← 最后一个：RTK-IMU GT
    "/mnt/sda/MapScape/query/estimation/result_images/Google/GeoPixel/switzerland_seq4@8@sunny@200.txt",  # 1612
    ...
    "/mnt/sda/MapScape/query/estimation/result_images/Google/GeoPixels/switzerland_seq4@8@rainy@200.txt",  #1605
