...
# ========== 可编辑区域 ==========
FILES = [
    "/media/ubuntu/PS20001/poses/switzerland_seq7@8@sunny@500.txt",  # ← 最后一个：RTK-IMU GT
    "/mnt/sda/MapScape/query/estimation/result_images/Google/GeoPixel/switzerland_seq7@8@sunny@500.txt",  # 1612
    # "/mnt/sda/MapScape/query/estimation/result_images/Google/GeoPixel/USA_seq2@8@cloudy@200.txt", #1602
    "/mnt/sda/MapScape/query/estimation/result_images/Google/GeoPixel/switzerland_seq7@8@foggy@intensity2@500.txt",  #1589
    "/mnt/sda/MapScape/query/estimation/result_images/Google/GeoPixel/switzerland_seq7@8@night@intensity1@500.txt",  #1612
    "/mnt/sda/MapScape/query/estimation/result_images/Google/GeoPixel/switzerland_seq7@8@sunset@500.txt",  #1598
    "/mnt/sda/MapScape/query/estimation/result_images/Google/GeoPixel/switzerland_seq7@8@rainy@500.txt",  #1605
    
]
SAVE_DIR = "/mnt/sda/MapScape/query/estimation/vis/"
SAVE_NAME = "switzerland_seq7@500.png"
USE_ID_UNION = True
