...
# ========== 可编辑区域 ==========
FILES = [
    "/media/ubuntu/PS20001/poses/switzerland_seq12@8@sunny@200.txt",  # ← 最后一个：RTK-IMU GT
    "/mnt/sda/MapScape/query/estimation/result_images/Google/GeoPixel/switzerland_seq12@8@sunset@200.txt",  # 1612
