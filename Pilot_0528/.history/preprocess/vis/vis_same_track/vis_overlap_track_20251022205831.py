...
def main(file_paths: List[str],
    ...
    # 右上角起始坐标 (坐标系范围内)
    x_start = ax_xy.get_xlim()[1] * 0.98  # 右边略留空
    y_start = ax_xy.get_ylim()[1] * 0.98  # 上边略留空
    line_height = (ax_xy.get_ylim()[1] - ax_xy.get_ylim()[0]) * 0.03  # 每行间距，按坐标系比例
