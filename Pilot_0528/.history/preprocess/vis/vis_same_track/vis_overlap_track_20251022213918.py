...
# ========== 可编辑区域 ==========
FILES = [
    "/media/ubuntu/PS20001/poses/USA_seq5@8@RTK-IMU GT@sunny@300-100@200 (copy).txt",  # ← 最后一个：RTK-IMU GT
    "/mnt/sda/MapScape/query/estimation/result_images/Google/GeoPixel/USA_seq5@8@sunny@300-100@200.txt",  # 1612
    "/mnt/sda/MapScape/query/estimation/result_images/Google/GeoPixel/USA_seq5@8@cloudy@300-100@200.txt", #1602
    "/mnt/sda/MapScape/query/estimation/result_images/Google/GeoPixelUSA_seq5@8@foggy@intensity2@300-100@200.txt",  #1589
