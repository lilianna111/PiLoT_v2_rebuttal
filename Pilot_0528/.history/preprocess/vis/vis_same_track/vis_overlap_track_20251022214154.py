...
# ========== 可编辑区域 ==========
FILES = [
    "/media/ubuntu/PS20001/poses/USA_seq8@8@RTK-IMU GT@sunny@200 (copy).txt",  # ← 最后一个：RTK-IMU GT
    "/mnt/sda/MapScape/query/estimation/result_images/Google/GeoPixel/USA_seq8@8@sunny@200.txt",  # 1612
    "/mnt/sda/MapScape/query/estimation/result_images/Google/GeoPixel/USA_seq8@8@cloudy@200.txt", #1602
    "/mnt/sda/MapScape/query/estimation/result_images/Google/GeoPixel/USA_seq8@8@foggy@intensity1@200.txt",  #1589
    "/mnt/sda/MapScape/query/estimation/result_images/Google/GeoPixel/USA_seq8@8@night@intensity2@200.txt",  #1612
    "/mnt/sda/MapScape/query/estimation/result_images/Google/GeoPixel/USA_seq8@8@sunset@200.txt",  #1598
