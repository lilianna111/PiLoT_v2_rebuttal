...
# ========== 可编辑区域 ==========
FILES = [
    "/mnt/sda/MapScape/query/poses/DJI_20250612194622_0018_V.txt",  # ← 最后一个：RTK-IMU GT
    "/mnt/sda/MapScape/query/estimation/result_images/FPVLoc/DJI_20250612194622_0018_V.txt",  # 1612
