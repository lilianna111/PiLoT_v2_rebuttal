...
# ========== 可编辑区域 ==========
FILES = [
    "/mnt/sda/MapScape/query/estimation/result_images/feicuiwan/GT/DJI_20250612194903_0021_V.txt",  # ← 最后一个：RTK-IMU GT
    "/mnt/sda/MapScape/query/estimation/result_images/feicuiwan/GeoPixel/DJI_20250612194903_0021_V.txt",  # 1612
...
SAVE_NAME = "DJI_20250612194903_0021_V.png"
USE_ID_UNION = True
...
def main(file_paths: List[str],
    ...
    # 对齐为并行数组
    XYs, Hs, PITs, YAWs = [], [], [], []
    first_points = tracks["/mnt/sda/MapScape/query/estimation/result_images/feicuiwan/GT/DJI_20250612194903_0021_V.txt"]['xyz'][0]
    for k in keys:
        d = tracks[k]
    ...
    with open("/mnt/sda/MapScape/query/estimation/result_images/feicuiwan/GT/DJI_20250612194903_0021_V.txt", 'w', encoding='utf-8') as f:
        first_points[-1] = 0
        gt_wgs84 = cgcs2000_to_wgs84_batch(gt+first_points, 4547)
        for i in range(len(gt)):
            euler_enu = [0, PITs[-1][i], YAWs[-1][i]]
