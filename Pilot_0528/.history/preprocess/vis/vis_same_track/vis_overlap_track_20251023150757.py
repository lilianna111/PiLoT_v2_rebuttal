...
# ========== 可编辑区域 ==========
FILES = [
    "/media/ubuntu/PS20001/poses/USA_seq5@8@RTK-IMU GT@sunny@500-400@500 (copy).txt",  # ← 最后一个：RTK-IMU GT
    "/mnt/sda/MapScape/query/estimation/result_images/Google/GeoPixel/USA_seq5@8@sunny@500-400@500.txt",  # 1612
    "/mnt/sda/MapScape/query/estimation/result_images/Google/GeoPixel/USA_seq5@8@cloudy@500-400@500.txt", #1602
    "/mnt/sda/MapScape/query/estimation/result_images/Google/GeoPixel/USA_seq5@8@foggy@500-400@intensity1@500.txt",  #1589
    "/mnt/sda/MapScape/query/estimation/result_images/Google/GeoPixel/USA_seq5@8@night@500-400@intensity1@500.txt",  #1612
    "/mnt/sda/MapScape/query/estimation/result_images/Google/GeoPixel/USA_seq5@8@sunset@500-400@500.txt",  #1598
