...
# ========== 可编辑区域 ==========
FILES = [
    "/mnt/sda/MapScape/query/estimation/result_images/feicuiwan/GT/DJI_20250612194150_0014_V.txt",  # ← 最后一个：RTK-IMU GT
    "/mnt/sda/MapScape/query/estimation/result_images/feicuiwan/GeoPixel/DJI_20250612194150_0014_V.txt",  # 1612
...
SAVE_NAME = "DJI_20250612194150_0014_V.png"
USE_ID_UNION = True
...
def main(file_paths: List[str],
    ...
    with open("/mnt/sda/MapScape/query/estimation/result_images/feicuiwan/GT/"+SAVE_NAME.split(".")[0]+".txt", 'w', encoding='utf-8') as f:
        ...
        for i in range(len(gt)):
            euler_enu = [0, PITs[-1][i], YAWs[-1][i]+0.5]
