...
# ========== 可编辑区域 ==========
FILES = [
    "/mnt/sda/MapScape/query/estimation/result_images/FPVLoc/DJI_20250612173353_0002_V.txt",  # ← 最后一个：RTK-IMU GT
    "/mnt/sda/MapScape/query/poses/DJI_20250612173353_0002_V.txt",  # 1612
