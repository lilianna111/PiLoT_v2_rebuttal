...
# ========== 可编辑区域 ==========
FILES = [
    "/mnt/sda/MapScape/query/poses/DJI_20250926150103_0001_V_1.txt",  # ← 最后一个：RTK-IMU GT
    "/mnt/sda/MapScape/query/estimation/result_images/FPVLoc/DJI_20250926150103_0001_V_1.txt",  # 1612
