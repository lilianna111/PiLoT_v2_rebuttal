...
# ========== 可编辑区域 ==========
FILES = [
    "/mnt/sda/MapScape/query/estimation/result_images/feicuiwan/GT/"+seq,  # ← 最后一个：RTK-IMU GT
    "/mnt/sda/MapScape/query/estimation/result_images/feicuiwan/Render2Loc/"+seq,  # 1612
...
SAVE_NAME = 'Render2Loc_'+seq.split('.')[0] 
USE_ID_UNION = True
