...
# === 数据表格 ===
data = {
    "Method": ["Render2ORB", "PiLoT", "Render2Loc", "Render2RAFT", "PixLoc"],
...
# }
methods_color = {
    "GeoPixel":    "#01665e",  # 深绿蓝（底层）
    "Render2Loc":  "#35978f",  # 墨青
    "PixLoc":      "#80cdc1",   # 几乎白的极浅青
    "Render2RAFT": "#c7eae5",  # 浅青
    "Render2ORB":  "#f6fff9"  # 雾蓝绿
...
for recall_name, recall_idx in recall_indices.items():
    ...
    for r in [20, 40, 60, 80, 100]:
        ax.text(np.pi / 2, r, f"{r}%", ha='center', va='bottom',
                fontsize=9, fontweight='bold', family='serif', zorder=2000)
