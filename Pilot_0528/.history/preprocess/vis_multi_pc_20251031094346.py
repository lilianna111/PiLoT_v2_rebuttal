...
def rgb(ftensor, true_shape=None):
    ...
    if isinstance(ftensor, torch.Tensor):
        ftensor = ftensor.detach().cpu().numpy()  # H,W,
...
image_files = sorted(glob.glob(os.path.join("/media/ubuntu/PS20001/images/USA_seq5@8@sunset@300-100@200", "*_0.png")))
...
for i, (img_file, depth_file) in enumerate(zip(image_files, depth_files)):
    if i % 10 !=0 or i < 700 or i > 800 : continue
