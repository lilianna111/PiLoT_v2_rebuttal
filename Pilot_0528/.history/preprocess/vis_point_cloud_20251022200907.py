...
if __name__=="__main__":
    ...
    euler_angles, translation,_ = get_init("/media/ubuntu/PS20001/poses/switzerland_seq7@8@rainy@500.txt", start=126)
    render_pose = [translation, euler_angles]
    rgb_path = "/media/ubuntu/PS20001/images/switzerland_seq7@8@cloudy@500/0_0.png"
    depth_pth = "/mnt/sda/MapScape/query/depth/switzerland_seq7@8@rainy@500/0_1.png"
