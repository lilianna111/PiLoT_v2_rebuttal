...
def quick_scatter3d_minimal(points_xyz: np.ndarray,
    ...
    inset.text(o[0], o[1] + L + 0.05, 'Z', color='#43A047', fontsize=9, ha='center')
    inset.arrow(o[0], o[1], L*0.6, L*0.6, width=0.012, head_width=0.06, head_length=0.08,
                length_includes_head=True, color='#1E88E5')
    inset.text(o[0] + L*0.6 + 0.05, o[1] + L*0.6 + 0.02, 'Y', color='#1E88E5', fontsize=9)
...
if __name__=="__main__":
    ...
    euler_angles, translation,_ = get_init("/media/ubuntu/PS20001/poses/USA_seq5@8@sunset@300-100@200.txt", start=752)
    render_pose = [translation, euler_angles]
    rgb_path = "/media/ubuntu/PS20001/images/USA_seq5@8@sunset@300-100@200/752_0.png"
    depth_pth = "/mnt/sda/MapScape/query/depth/USA_seq5@8@cloudy@300-100@200/752_1.png"
