...
for target_name in "${target_names[@]}"; do
  ...
  if [[ $index -ge 0 ]]; then
    ...
    echo "--- fpvloc"
    python /home/amax/Documents/code/pilot_v2/pilot_v2/Pilot_0528/main.py \
      --config "/home/amax/Documents/code/pilot_v2/pilot_v2/Pilot_0528/configs/feicuiwan_m4t.yaml" \
      --init_euler "$euler" \
      --init_trans "$trans" \
      --name "$target_name"
