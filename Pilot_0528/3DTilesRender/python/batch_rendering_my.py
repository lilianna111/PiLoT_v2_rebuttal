...
if __name__ == "__main__":
    ...
    pose_save_path = "/media/amax/AE0E2AFD0E2ABE69/datasets/poses/DJI_20251221132525_0004_V_1.txt"
    render_path = "/media/amax/AE0E2AFD0E2ABE69/datasets/renders/0004"
    if not os.path.exists(render_path):
        os.makedirs(render_path)
    
    # load map 
    config_web['outputs'] =  os.path.join(render_path)
    with open(pose_save_path, 'r') as f:
        for data in f.read().rstrip().split('\n'):
            ...
            config_web['image_id'] =  name.split('.')[0]
