...
def load_poses(pose_file, origin = None):
    ...
    return pose_dict
def process_map_crop(ref_DSM_path, pose_data, ref_npy_path, name, map_data_pack, paths_pack):        # 包含输出路径
    """
...
class DualProcessTask:        
    def __init__(self, config, init_euler = None, init_trans = None, name = None):
        ...
        pre_path = "/home/amax/Documents/datasets/output/test"
    ...
    def rendering_worker(self):
        ...
        # -----------------------------------------------DEM----------------------------------------------
        ref_DOM_path = "/home/amax/Documents/datasets/DEM/fcwdom.tif"
        ref_DSM_path = "/home/amax/Documents/datasets/DEM/fcwdem.tif"
        ref_npy_path = "/home/amax/Documents/datasets/DEM/fcw.npy"
        ...
        while True:
            ...
            if points_valid.shape[0] == 0:
                ...
                continue
            sample_num = min(5000, points_valid.shape[0])
    ...
    def localization_worker(self):
        ...
        for idx, (img_path, img_tensor) in enumerate(zip(self.img_list, self.query_list)):
            ...
            P3d, T_w2c_mod, T_init, dd, p2d_r_final = self.back_project(depth, p2d_r, render_euler, render_trans, last_euler, last_trans)
    ...
    def back_project(self, points_3d_input, p2d_r_input, euler_angles, translation, query_euler_angles, query_translation, num_samples = None, device = 'cuda'):
        ...
        Points_3D_ECEF, T_render_in_ECEF_w2c_modified, T_initial_pose_candidates, dd, p2d_r_filtered = get_3D_samples_v3(
            mkpts_r=p2d_r_input, 
            depth_mat=points_3d, 
        ...
        return Points_3D_ECEF, T_render_in_ECEF_w2c_modified, T_initial_pose_candidates, dd, p2d_r_filtered
    # 假设的计算位姿函数
