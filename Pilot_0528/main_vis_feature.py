...
class DualProcessTask:        
    def __init__(self, config, init_euler = None, init_trans = None, name = None):
        ...
        self.pose_q.put_nowait((self.euler_angles, self.translation, 'init.png'))
        self.pose_q.put_nowait((self.euler_angles, self.translation,'init.png'))
    # ---------------- 渲染线程 ----------------        
    ...
    def localization_worker(self):
        ...
        for idx, (img_path, img_tensor) in enumerate(zip(self.img_list, self.query_list)):
            ...
            if idx < len(self.img_list)-1:
                self.pose_q.put((ret['euler_angles'], ret['translation'], qname))
...
if __name__ == "__main__":
    ...
    # name = "DJI_20250927082946_0001_V"
    # config_file = "/home/ubuntu/Documents/code/github/FPV/PiLoT_long_vido/configs/feicuiwan_m4t.yaml"
