...
class BaseRefiner:
    ...
    def refine_query_pose(self, qname: str, qcamera: Camera, ref_camera: Camera, render_frame, T_query_initial: Pose, T_render: Pose, Points_3D_ECEF, p2d_r=None,visible_r=None,dd = None,
                          multiscales: Optional[List[int]] = None, gt_pose_dict=None, last_frame_info = {}, query_resize_ratio = 1, image_query=None) -> Dict:
        (qcamera, ref_camera, render_frame, T_query_initial, T_render, Points_3D_ECEF, p2d_r,visible_r, dd, last_frame_info) = \
        move_inputs_to_cuda(qcamera, ref_camera, render_frame, T_query_initial, T_render, Points_3D_ECEF, p2d_r,visible_r, dd, last_frame_info)
        ...
        ret = self.refine_pose_using_features(features_query, scales_query,
                                            ...
                                            features_ref_dense, scales_ref, p2d_r=p2d_r,visible_r=visible_r, p3d = Points_3D_ECEF)
