...
class BaseRefiner:
    ...
    def refine_query_pose(self, qname: str, qcamera: Camera, ref_camera: Camera, render_frame, T_query_initial: Pose, T_render: Pose, Points_3D_ECEF, dd = None,
                          multiscales: Optional[List[int]] = None, gt_pose_dict=None, last_frame_info = {}, query_resize_ratio = 1, image_query=None,dsm_path=None,gt_depth=None) -> Dict:
        ...
        ret = self.refine_pose_using_features(features_query, scales_query,
                                            ...
                                            features_ref_dense, scales_ref, p3d = Points_3D_ECEF,dsm_path=dsm_path,gt_depth=gt_depth, dd=dd, mul=mul, origin=self.origin)
