...
class BaseRefiner:
    ...
    def refine_pose_using_features(self,
        ...
        # for idx, level in enumerate(range(len(features_query))):
            ...
            # vis===================
            # _, topk_indices = torch.topk(-overall_loss, 100, dim=-1, largest=True, sorted=True)
            # _, topk_indices_1 = torch.topk(-overall_loss, 1, dim=-1, largest=True, sorted=True)
            ...
            #     "p2d_query_refined_last": p2d_query_refined[topk_indices_1],
            #     "f_q": F_q,
            ...
            # torch.save(inputs, "/home/ubuntu/Documents/code/github/FPV/FPV-Test-512-cuda/feature_vis_outputs/DJI_20250804192327_0002_V/6444/"+name)
