...
class RenderLocalizer(Localizer):
    ...
    def run_query(self, name: str, camera: Camera, ref_camera: Camera, render_frame, query_T = None, render_T = None, Points_3D_ECEF = None, p2d_r=None, visible_r=None,dd = None, gt_depth=None, dsm_path=None, render_T_ecef=None, gt_pose_dict = None, last_frame_info = {}, query_resize_ratio = 1,image_query=None):
        ret = self.refiner.refine_query_pose(name, camera, ref_camera, render_frame, query_T, render_T, Points_3D_ECEF, p2d_r,visible_r, dd = dd, gt_depth=gt_depth, dsm_path=dsm_path, render_T_ecef=render_T_ecef, gt_pose_dict=gt_pose_dict,last_frame_info = last_frame_info, query_resize_ratio = query_resize_ratio,image_query= image_query)
        return ret
