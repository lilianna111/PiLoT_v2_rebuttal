...
class DirectAbsoluteCost2:
    ...
    def residual_jacobian_batch_quat(
        ...
        if (
            ...
            # === Step 7: 角度约束 (roll/pitch -> 0) ===
            # Use numeric Jacobian w.r.t. pose_data_q rotation parameters.
            angle_weight = 1.0
            ...
            # residuals are roll/pitch (radians)
            ...
            grad_angle[0, :, :3] = grad_rot
            # Hess: J^T J
            Hess_rot = torch.einsum("nri,nrj->nij", J_t, J_t) * angle_weight
            Hess_angle[0, :, :3, :3] = Hess_rot

            grad = grad + grad_angle
            Hess = Hess + Hess_angle
