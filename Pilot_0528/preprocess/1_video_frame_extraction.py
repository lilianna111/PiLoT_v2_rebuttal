...
import math
# ==== 配置 ====
video_path = '/mnt/sda/MapScape/sup/feicuiwan/DJI_20250612183852_0005_V.MP4'  # 输入视频路径
output_dir = '/mnt/sda/MapScape/query/images/DJI_20250612183852_0005_V'       # 输出图像文件夹
frame_interval = 1         # 每隔多少帧保存一次（1 表示逐帧）
target_width = 3840
target_height = 2160
print(output_dir)
# ==== 裁切秒数（可选）====
start_sec = 44              # None 表示从头开始
end_sec = 73               # None 表示直到结束

# ==== 最大输出帧数（可选）====
max_output_frames = 900    # None 表示不限制数量
