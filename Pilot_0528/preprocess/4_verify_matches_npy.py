...
if __name__ == "__main__":
    ...
    lon, lat, alt, roll, pitch, yaw = [112.992637, 28.294052, 71.69, 0.0, 28.5000, 48.20]
    ...
    K_w2c = [1920, 1080, 1350.0, 1350.0, 960.0, 540.0]
    ...
    # 1. 定义单点像素坐标
    pixel_ref = np.array([[960, 540]])  # 参考帧的像素点

    # 2. 读取参考帧深度（npy 或 cv2）
    ref_depth_image = np.load('/media/amax/AE0E2AFD0E2ABE69/datasets/renders/0004/0_0.npy')
    query_depth_image = np.load('/media/amax/AE0E2AFD0E2ABE69/datasets/renders/0004/0_0.npy')
